    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
        ...
        <main class="p-6">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-3xl font-bold text-white">PTDC</h2>
            ...
            <div class="glass rounded-xl border border-white/5 overflow-hidden p-6">
                <table id="committeeTable" class="w-full text-left text-sm text-slate-400">
...
<script>
    ...
    async function loadData() {
        ...
        try {
            const response = await fetch('api/committee_action.php', { method: 'POST', body: formData });
            ...
            if (result.status === 'success') {
                ...
                result.data.forEach(row => {
                    const photoHtml = row.photo 
                        ? `<img src="uploads/committee/${row.photo}" class="h-10 w-10 rounded-full object-cover border border-slate-600">`
                ...
                initializeDataTable('#committeeTable');
            }
        } catch (e) { console.error(e); }
    }

    // Dropdowns
    async function loadDesignations() { /* Defined below */ }
    ...
    async function editData(id) {
        ...
        try {
            ...
            if (result.status === 'success') {
                ...
                if (data.photo) {
                    img.src = 'uploads/committee/' + data.photo;
